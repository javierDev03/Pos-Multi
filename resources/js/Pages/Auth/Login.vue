                ...
                <div
                    ...
                    <div
                        ...
                        <div class="block px-2">
                            <h2 class="font-bold text-xl lg:text-3xl mb-4 text-black lg:text-white dark:text-white">¿Aún
                                no tienes una cuenta?</h2>
                            <p class="text-xs text-gray-600 lg:text-white dark:text-white">Registrate y empieza a cargar
                                tus escritos en las convocatorias desplegadas!</p>
                            <Link href="/register" class="lg:hidden text-xs text-blue-500 underline-offset-4 hover:underline hover:text-blue-700 hover:dark:text-blue-400">Da clic Aquí</Link>
                                
                            <BaseButton class="w-auto mt-6 hidden lg:flex" type="submit" color="info" label="Registrarse"
                                href="/register" />
                        </div>
                    </div>
                </div>
