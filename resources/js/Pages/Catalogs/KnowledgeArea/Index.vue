...
const state = reactive({
    filters: {
        search: search,
        order: props.areas.order ?? "created_at",
...
<template>
    ...
    <LayoutMain>
        ...
        <form @submit.prevent="filterSearch" class="w-full mb-5">
            <div class="flex flex-col md:flex-row justify-between">
                ...
                <BaseButtons class="flex space-x-2">
                    <BaseButton :routeName="`${routeName}create`" color="info" :icon="mdiPlus" label="Agregar Programa"
        ...
        <CardBox v-if="areas.data.length > 0">
            <table>
                <thead>
                    <tr>
                        <th />
                ...
                <tbody>
                    <tr v-for="item in areas.data" :key="item.id">
        ...
        <pagination :links="areas.links" :total="areas.total" :to="areas.to" :from="areas.from" />
        <div class="vl-parent">
