...
const state = reactive({
    filters: {
        search: search,
        order: props.subareas.order ?? "created_at",
...
<template>
    ...
    <LayoutMain>
        ...
        <form @submit.prevent="filterSearch" class="w-full mb-5">
            <div class="flex flex-col md:flex-row justify-between">
                ...
                <BaseButtons class="flex space-x-2">
                    <BaseButton :routeName="`${routeName}create`" color="info" :icon="mdiPlus" label="Agregar Área"
        ...
        <CardBox v-if="subareas.data.length > 0">
            <table>
                <thead>
                    <tr>
                        <th />
                        ...
                        <th>
                            <Dropdown title="Área Prioritaria" :options="opts" />
                        </th>
                        ...
                        <th>
                            <Dropdown title="Programa" :options="opts" />
                        </th>
                ...
                <tbody>
                    <tr v-for="item in subareas.data" :key="item.id">
                        ...
                        <td data-label="Área Prioritaria">
                            {{ item.name }}
                        </td>
                        ...
                        <td data-label="Acciones">
                            <BaseButtons>
                                <BaseButton color="info" :icon="mdiPencil" small :routeName="`${routeName}edit`"
                                    :parameter="item.id" title="Editar subárea" />
                            </BaseButtons>
                        </td>
                    </tr>
                </tbody>
        ...
        <pagination :links="subareas.links" :total="subareas.total" :to="subareas.to" :from="subareas.from" />
        <div class="vl-parent">
