...
<template>
    ...
    <LayoutMain>
        ...
        <CardBox isForm @submit.prevent="saveForm">
            <FormField label="Nombre:" :required="true" help="Nombre del criterio" :error="form.errors.name">
                <FormControl v-model="form.name" placeholder="..." />
            </FormField>

            <FormField label="Descripción:" :required="true" :error="form.errors.description">
                <FormControl height="h-32" type="textarea" v-model="form.description" placeholder="Descripción" />
            </FormField>
