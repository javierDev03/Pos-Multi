...
const state = reactive({
    filters: {
        search: search,
        order: props.calls.order ?? "created_at",
...
const opts = [
    ...
    },
    {
        ...
        key: "start_date",
        menu: [
            { title: "Ordenar reciente ", direction: "asc" },
            { title: "Ordenar antiguo ", direction: "desc" },
        ],
    },
    {
        label: "Fecha fin",
...
<template>
    ...
    <LayoutMain>
        ...
        <form @submit.prevent="filterSearch" class="w-full mb-5">
            <div class="flex flex-col md:flex-row justify-between">
                ...
                <BaseButtons class="flex space-x-2">
                    <BaseButton :routeName="`${routeName}create`" color="info" :icon="mdiPlus"
                        label="Agregar convocatoria" class="flex-1 h-11 rounded-l-lg " />
        ...
        <CardBox v-if="calls.data.length > 0">
            <table>
                <thead>
                    <tr>
                        <th />
                        ...
                        <th>
                            <Dropdown title="Título" :options="opts" />
                        </th>
                        ...
                        <th>
                            <Dropdown title="Fecha de inicio" :options="opts" />
                        </th>
                        <th>
                            <Dropdown title="Fecha fin" :options="opts" />
                        </th>
                        <th>
                            <span
                ...
                <tbody>
                    <tr v-for="item in calls.data" :key="item.id">
                        ...
                        <td data-label="Acciones">
                            <BaseButtons>
                                <BaseButton color="info" :icon="mdiPencil" small :routeName="`${routeName}edit`"
                                    :parameter="item.id" title="Editar convocatoria" />
        ...
        <pagination :links="calls.links" :total="calls.total" :to="calls.to" :from="calls.from" />
        <div class="vl-parent">
