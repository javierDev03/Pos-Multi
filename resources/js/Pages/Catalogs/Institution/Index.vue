...
const state = reactive({
    filters: {
        search: search,
        order: props.institutions.order ?? "created_at",
...
<template>
    ...
    <LayoutMain>
        ...
        <form @submit.prevent="filterSearch" class="w-full mb-5">
            <div class="flex flex-col md:flex-row justify-between">
                ...
                <BaseButtons class=" flex space-x-2">
                    <BaseButton :routeName="`${routeName}create`" color="info" :icon="mdiPlus" label="Agregar institución"
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>
                            <Dropdown title="Institución" :options="opts" />
                        </th>
                        <th>
                            <Dropdown title="Pais" :options="opts" />
                        </th>
                        <th>
                        ...
                        <td data-label="Acciones">
                            <BaseButtons>
                                <BaseButton color="info" :icon="mdiPencil" small :routeName="`${routeName}edit`"
                                    :parameter="item.id" title="Editar institución" />
                            </BaseButtons>
                        </td>
                    </tr>
                </tbody>
        ...
        <pagination :links="institutions.links" :total="institutions.total" :to="institutions.to"
