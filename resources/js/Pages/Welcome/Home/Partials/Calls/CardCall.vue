...
<template>
    <div
        ...
        <div class="px-4">
            ...
            <div class="justify-between flex space-x-2 mt-4">
                <BaseButton small :icon="mdiArrowRight" @click="$emit('openModal', call)" color="info"
                    label="Conocer más" />
                <BaseButton small :icon="mdiCheck" :href="route('article.create', { id: call.id })" color="success"
                    label="Inscribirse" />
            </div>
        </div>
    </div>
